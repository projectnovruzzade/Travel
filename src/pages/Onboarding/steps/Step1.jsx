...
const Step1 = ({ onAdvance }) => {
  ...
  const handleStyleClick = (value) => {
    if (userTravelStyle === value) {
      // Eyni option-a 2-ci dəfə klikləndikdə növbəti stepə keç
      onAdvance?.();
    } else {
  ...
  return (
    <div className="step-content">
      ...
      <div className="travel-style-content">
        <div className="content-item active" onClick={() => handleStyleClick('active')}>
        ...
        <div className="content-item passive" onClick={() => handleStyleClick('passive')}>
